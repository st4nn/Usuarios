  ...
  options = {
	...
	trackFormatter : function(o)
		...
		var summaryTicks = Res;
			...
			{
				var f = summaryTicks[o.index].Hora.split(':');
				var addH = parseInt(f[0]) + 1;
				if (addH < 10)
				{
					addH = '0' + addH;
				}
				...
				value = "Usuarios Simultaneos: " + parseInt(data[o.index][1]) + "<br>" +
											summaryTicks[o.index].Fecha + "<br>" +
											summaryTicks[o.index].Hora + " - " + addH + ':00:00';
			}
			if ($("input[name='TipoAgrupacion']:checked").val() == "Dia")
			{
				value = "Usuarios Simultaneos: " + parseInt(data[o.index][1]) + "<br>" +
											summaryTicks[o.index].Fecha;
			}
			if ($("input[name='TipoAgrupacion']:checked").val() == "Mes")
			{
				var f = new Date(summaryTicks[o.index].Fecha);
			...
			/*value = "Usuarios Simultaneos: " + data[o.index][1] + "<br>" +
											summaryTicks[o.index].Fecha + "<br>" +
											summaryTicks[o.index].Hora + "<br>" *//*+
		summaryTicks[o.index].Ip + "<br>" +
		summaryTicks[o.index].Conexiones + "<br>" +
		summaryTicks[o.index].IO*/
